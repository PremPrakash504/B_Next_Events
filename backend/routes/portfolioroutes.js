...
import { addPortfolio, getPortfolio, getPortfolioById, updatePortfolio, deletePortfolio } from "../controller/portfolio.controller.js";
...
portfoliorouter.get("/getportfolio/:id", getPortfolioById);
